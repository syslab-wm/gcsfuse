...
func (fs *fileSystem) ReadFile(
	...
	if err == nil && fs.encKey != nil {
		cryptox.AESCTRStream(fs.encKey, fs.iv, op.Offset, op.Dst[:op.BytesRead], op.Dst[:op.BytesRead])
	}
...
func (fs *fileSystem) WriteFile(
	...
	if fs.encKey != nil {
		cryptox.AESCTRStream(fs.encKey, fs.iv, op.Offset, op.Data, op.Data)
	}
